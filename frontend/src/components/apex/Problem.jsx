    ...
    <section id="problem" className="scroll-mt-24 bg-white py-24 lg:py-32">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {/* The Manual Way */}
          <div className="glossy-border glow-cast rounded-[24px] bg-white p-6 lg:p-7">
          ...
          <div className="glossy-border glow-cast rounded-[24px] bg-gradient-to-b from-brand-50/50 to-white p-6 lg:p-7">
            <div className="flex items-center gap-2.5 mb-6">
