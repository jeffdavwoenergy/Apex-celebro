  ...
  return (
    <section className="bg-[#F4F6FB] px-4 sm:px-6 py-14 lg:py-20">
      <div className="container mx-auto">
        ...
        <div className="glossy-border glossy-strong relative rounded-[24px] max-w-2xl mx-auto">
          <div className="group relative rounded-[23px] overflow-hidden bg-ink aspect-video cursor-pointer">
